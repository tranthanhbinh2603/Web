...
(function (App) {
    ...
    class ProjectState extends State {
        ...
        addTask(objTask) {
            ...
            this.listTask.push(new App.Project(id, name, description, peopleJoin, App.ProjectType.active));
    ...
    class ProjectList extends BaseComponent {
        ...
        dropHandler(event) {
            ...
            projectStateObject.changeStatus(id, this.type === "active" ? App.ProjectType.active : App.ProjectType.finished);
        }
        dragLeaveHandler(_) {
            const ulElement = this.element.querySelector("ul");
